...
class ClazzesTeachersFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        '_indexes' => [
            'fk_clazzes_teachers_docente1_idx' => ['type' => 'index', 'columns' => ['teacher_id'], 'length' => []],
        ],
        '_constraints' => [
            'primary' => ['type' => 'primary', 'columns' => ['clazz_id', 'teacher_id'], 'length' => []],
            'fk_clazzes_teachers_docente1' => ['type' => 'foreign', 'columns' => ['teacher_id'], 'references' => ['teachers', 'id'], 'update' => 'noAction', 'delete' => 'noAction', 'length' => []],
            'fk_clazzes_teachers_turma1' => ['type' => 'foreign', 'columns' => ['clazz_id'], 'references' => ['clazzes', 'id'], 'update' => 'noAction', 'delete' => 'noAction', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
