<?php $this->assign('title', 'Horário de aula: '.$schedule->code); ?>
<?php $this->start('breadcrumb'); ?>
<li><?= $this->Html->link('<i class="fa fa-dashboard"></i>' . __('Dashboard'), '/', ['escape' => false]) ?></li>
<li><?= $this->Html->link(__('Horários de aula'), ['action' => 'index']) ?></li>
<li class="active"><?= $schedule->code ?></li>
<?php $this->end(); ?>
        ...
        <div class="box box-primary">
            ...
            <div class="box-body table-responsive no-padding">
                <table class="table table-striped table-valign-middle">
                    ...
                    <tr>
                        <th><?= __('Código') ?></th>
                        <td><?= $this->Number->format($schedule->code) ?></td>
                    </tr>
                    <tr>
                        <th><?= __('Horário de início') ?></th>
                        <td><?= $this->Number->format($schedule->initial_time) ?></td>
                    </tr>
                    <tr>
                        <th><?= __('Horário de término') ?></th>
                        <td><?= $this->Number->format($schedule->final_time) ?></td>
                    </tr>
                </table>
            </div>
        </div>
